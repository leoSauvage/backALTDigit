...
const questionnaireRouter = router.group(() => {
    ...
    router.post('/questionnaires/:id/questions', '#controllers/Conseil/Actions/questionnaire.addQuestion')

    // Mettre à jour une question
    router.put('/questionnaires/:id/questions/:questionId', '#controllers/Conseil/Actions/questionnaire.updateQuestion')

    // Supprimer une question
    router.delete('/questionnaires/:id/questions/:questionId', '#controllers/Conseil/Actions/questionnaire.deleteQuestion')

    // Réorganiser les questions
    router.put('/questionnaires/:id/reorder', '#controllers/Conseil/Actions/questionnaire.reorderQuestions')
})
    .prefix('/api/conseil')
    //.middleware(['auth'])
